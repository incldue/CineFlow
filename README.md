...
**CineFlow** 基于 Electron + Vite 构建，使用 TMDB 数据源，支持自然语言搜索、个性化推荐、灵动岛模式、外部片源导入与应用内播放。

## 简介

**CineFlow** 是一款面向 Windows 桌面的电影/节目推荐应用，主打简洁的黑曜石UI、灵动岛模式、外部片源导入与应用内播放体验。它使用TMDB作为元数据源，支持电影、电视剧、节目、演员、关键词与类型发现。
